...
for line in fileInput.readlines():
    if '<div class="layout">' in line:
        ...
        fileOutput.write('<tr>\n')
        fileOutput.write(
            '<td width="250" class="scenarioSuccess">Tested KPIs: </td>\n')
        fileOutput.write(
            '<td class="scenarioSuccessValue"><strong>' + testedKPIs + '</strong></td>\n')
        fileOutput.write('</tr>\n')
        fileOutput.write('<tr>\n')
        fileOutput.write('<td class="scenarioSuccess">Passed KPIs: </td>\n')
        fileOutput.write(
            '<td class="scenarioSuccessValue"><strong>' + passedKPIs + '</strong></td>\n')
        fileOutput.write('</tr>\n')
        fileOutput.write('<tr>\n')
        fileOutput.write('<td class="scenarioSuccess">No Data KPIs: </td>\n')
        fileOutput.write(
            '<td class="scenarioSuccessValue"><strong>' + noDataKPIs + '</strong></td>\n')
        fileOutput.write('</tr>\n')
        fileOutput.write('<tr>\n')
        fileOutput.write('<td class="scenarioSuccess">Failed KPIs: </td>\n')
        fileOutput.write(
            '<td class="scenarioSuccessValue"><strong>' + failedKPIs + '</strong></td>\n')
        fileOutput.write('</tr>\n')
        fileOutput.write('<tr>\n')
        fileOutput.write('<td class="' + scenarioType +
                         '">Test result: </td>\n')
        fileOutput.write(
            '<td class="scenarioSuccessValue"><strong>' + KPIresult + '</strong></td>\n')
        fileOutput.write('</tr>\n')
        ...
        fileOutput.write(
            '<img src="TestRunner.png" alt="Test Runner screenshot">\n')
